// Protège /REF/ (référentiels des diplômes) : tout personnel actif ayant le droit « referentiels » (vérifié côté serveur).
const SB = "https://olqclfsywasktwirswpb.supabase.co";
const KEY = "sb_publishable_Qry6l1DGbG9IkLtGT7CF4w_OyP4rI8x";
const DROITS = ["referentiels"];
...
export async function onRequest(ctx) {
  ...
  if (m) {
    ...
    if (r.ok) {
      ...
      if (!ok && d && d.actif) {
        // tout personnel actif peut consulter les référentiels
